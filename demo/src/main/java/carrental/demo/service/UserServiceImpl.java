...
import carrental.demo.model.Role;
...
public class UserServiceImpl implements UserService {
	...
	public User save(UserRegistrationDto registrationDto) {
		User user=new User(registrationDto.getUsername(), registrationDto.getEmail(),passwordEncorder.encode(registrationDto.getPassword()), Arrays.asList(new Role("ROLE_USER")));
